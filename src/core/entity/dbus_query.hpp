    ...
    public std::enable_shared_from_this<DBusInstance>
{
  ...
  public:
        ...
        dbusQuery(queryObject)
    {
        ...
        {
            LOG_ERROR << "Fail to supplement DBusInstance by a default "
                         "metadata fields. Error="
                      << ex.what();
        }
    }

    virtual ~DBusInstance() noexcept = default;

    const std::vector<DBusInstancePtr> getComplexInstances() const;

    void fillMembers(const InterfaceName&, const DBusPropertiesMap&);
    ...
    void bindListeners(sdbusplus::bus::bus&, const EntityPtr&);
...
class DBusMemberInstance final : public IEntity::IEntityMember::IInstance
{
  ...
  public:
    ...
    {}
    virtual ~DBusMemberInstance() noexcept = default;
...
class DBusQuery : public IQuery<TInstance, sdbusplus::bus::bus>
{
  ...
  public:
    ...
    explicit DBusQuery() noexcept = default;
    ~DBusQuery() noexcept override = default;

    const DbusVariantType processFormatters(const PropertyName&,
                                            const DbusVariantType&) const;
    ...
    virtual void registerObjectCreationObserver(sdbusplus::bus::bus&) = 0;
    virtual void registerObjectRemovingObserver(sdbusplus::bus::bus&) = 0;

  protected:
    using FormatterFn = std::function<const DbusVariantType(
        const PropertyName&, const DbusVariantType&)>;
    ...
    virtual void supplementByStaticFields(DBusInstancePtr&)
    {}
...
class DBusQueryBuilder final
{
  ...
  public:
    ...
    virtual ~DBusQueryBuilder() noexcept = default;
    ...
    public std::enable_shared_from_this<FindObjectDBusQuery>
{
  public:
    ...
    {}
    ~FindObjectDBusQuery() noexcept override = default;

    std::vector<IEntity::InstancePtr> process(sdbusplus::bus::bus&) override;

    void registerObjectCreationObserver(sdbusplus::bus::bus&) override;
    void registerObjectRemovingObserver(sdbusplus::bus::bus&) override;
    ...
    public std::enable_shared_from_this<IntrospectServiceDBusQuery>
{
  ...
  public:
    ...
    {}
    ~IntrospectServiceDBusQuery() noexcept override = default;
